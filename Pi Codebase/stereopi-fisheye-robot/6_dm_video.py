...
def stereo_depth_map(rectified_pair):
    ...
    # if key == ord("c") :
    # cv2.imwrite("./dm_video/dm.jpg" , disparity_color)
    
    # Save Video
    # result = cv2.VideoWriter('./dm_video/vid.avi', cv2.VideoWriter_fourcc(*'MJPG'), 10, (640, 240))
    # esult.write(disparity_color)
...
for frame in camera.capture_continuous(capture, format="bgra", use_video_port=True, resize=(img_width,img_height)):
    ...
    # show the frame
    #cv2.imwrite("./dm_video/left.jpg" , imgLcut)
    #cv2.imwrite("./dm_video/right.jpg" , imgRcut)
